...
# Exploratory analysis (not reported in the paper): Do a robust regression
...
library(robustbase)
l1 <- lmrob(RRS.z~h_index_first_au.z + academic_age_first_au.z, S1)
l2 <- lmrob(RRS.z~h_index_first_au.z + academic_age_first_au.z, S2.MR)

l1 <- lmrob(RRS.z~h_index_first_au.z + publication_age, S1)
l2 <- lmrob(RRS.z~h_index_first_au.z + publication_age, S2.MR)
summary(l1)
summary(l2)
